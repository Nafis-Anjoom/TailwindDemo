    ...
    return(
        <div className="flex bg-cover bg-center h-80 align-baseline bg-[#51606A]">
            <div className="flex pl-8 pb-8 self-end">
                <div className="hidden sm:inline-block items-center sm:h-48 sm:w-48 xl:h-56 xl:w-56">
                ...
                <div className="self-end ml-3">
                    ...
                    <div className="text-6xl md:text-7xl lg:text-8xl font-extrabold shrink">Joey Bada$$</div>
